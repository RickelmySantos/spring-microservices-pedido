...
public class NotificacaoProducer {
    ...
    public void enviarNotificacao(String mensagem) {
        ...
        this.rabbitTemplate.convertAndSend("notificacao-exchange", "notificacao-routing-key",
                mensagem);
    }
    ...
    public void enviarNotificacaoComDelay(String mensagem, long delayMillis) {
        ...
        this.rabbitTemplate.convertAndSend("notificacao-delay-exchange", "notificacao.delay",
                message);
    }
}
