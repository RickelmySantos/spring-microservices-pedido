...
public final class TestDataBuilder {
  ...
  public static class PedidoTestBuilder {
    ...
    private String emailUsuario = "joao@teste.com";
    ...
    public Pedido build() {
      return Pedido.builder().id(this.id).usuarioId(this.usuarioId).observacao(this.observacao)
          .nomeUsuario(this.nomeUsuario).emailUsuario(this.emailUsuario).status(this.status)
  ...
  public static final class TestConstants {
    public static final String USER_ID_PADRAO = "user123";
    public static final String NOME_USUARIO_PADRAO = "João Silva";
    public static final String EMAIL_USUARIO_PADRAO = "joao@teste.com";
    public static final String OBSERVACAO_PADRAO = "Observação de teste";

    public static final Long PRODUTO_ID_PADRAO = 1L;
    public static final String NOME_PRODUTO_PADRAO = "Produto Teste";
    public static final Integer QUANTIDADE_PADRAO = 2;
    public static final BigDecimal PRECO_UNITARIO_PADRAO = BigDecimal.valueOf(29.99);
