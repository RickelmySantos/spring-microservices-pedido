            ...
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-blue-100">Share your favorite moments with us</p>
                    </div>
            ...
            <div class="p-6">
                <div class="form-file">
                    ...
                    <label for="fileInput" class="cursor-pointer">
                        ...
                        <div class="text-sm text-gray-400">Supports: JPG, PNG, GIF (Max 5MB each)</div>
                    </label>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3">
                    ...
                    <button
                        ...
                        id="uploadBtn"
                        class="upload-btn px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 flex items-center justify-center gap-2">
