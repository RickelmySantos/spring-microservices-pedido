            ...
            <div class="p-6">
                <div class="form-file">
                    ...
                    <label for="fileInput" class="cursor-pointer">
                        ...
                        <h3 class="text-lg font-medium text-p-gray-700 mb-1">Drag & drop files here</h3>
                        <p class="text-p-gray-500 mb-4">or click to browse</p>
                        <div class="text-sm text-p-gray-400">Suporta: JPG, PNG</div>
                    </label>
                    <div *ngIf="form.get('imagem')?.invalid && form.get('imagem')?.touched" class="text-red-600 text-sm mt-2">Imagem é obrigatória</div>
                </div>

                <div class="mb-6">
                    <h3 class="text-lg font-medium text-p-gray-700 mb-4">Formulário</h3>
                    <div class="grid">
                        <div class="col-6">
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3">
                    <button type="button" class="px-6 py-2 border border-p-gray-300 border-round text-p-gray-700  hover:bg-p-gray-50 transition cursor-pointer " (click)="form.reset()">
                        Cancelar
                    </button>
